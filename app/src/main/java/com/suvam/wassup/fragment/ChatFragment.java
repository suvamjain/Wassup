...
import com.suvam.wassup.adapter.ChatAdapter;
import com.suvam.wassup.utils.PaginationScrollListener;

import java.util.List;
import java.util.Objects;

public class ChatFragment extends Fragment implements QuerySearchResults {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((MainActivity) Objects.requireNonNull(getActivity())).setActivityListener(1, ChatFragment.this);
    ...
    private void loadNextPage() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                List<Object> results = sampleData.getChatsData(currentPage);
    ...
    private void loadFirstPage() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                List<Object> results = sampleData.getChatsData(PAGE_START);
                mAdapter.addAll(results);
